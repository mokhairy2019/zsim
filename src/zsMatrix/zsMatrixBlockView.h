...
// isConst .. to do
    ...
    public:
        ...
        zsMatrixBlockView() : m_rowSize(0), m_colSize(0)
        { }
        ...
        zsMatrixBlockView(const MatrixType & matrix)
                : m_rowSize(1),
                  m_colSize(1)
        {
        ...
        /// Copy constructor
        zsMatrixBlockView (const zsMatrixBlockView & other)
        {
            freeAll(m_blocks);
            m_blocks.clear();
    ...
    public:
        ...
        {
            ZSIM_ASSERT( i < m_rowSize && j < m_colSize ,
        ...
        zsMatrixBlockView & operator = (zsMatrixBlockView  other)
        {
            if(this != &other)
            {
        ...
        friend std::ostream & operator << (std::ostream & os, const zsMatrixBlockView & mv)
        {
