...
#pragma omp critical
    ...
    void
    zsEngngModel :: assembleExtrapolatedForces(FloatArray &answer, TimeStep *tStep, CharType type, Domain *domain)
    {
...
#pragma omp critical
    ...
    void
    zsEngngModel :: assemblePrescribedExtrapolatedForces(FloatArray &answer, TimeStep *tStep, CharType type, Domain *domain)
    {
        // Simply assembles contributions from each element in domain
        zsIntArray loc;
        FloatArray charVec, delta_u;
...
#pragma omp critical
    ...
    void
    zsEngngModel :: assembleVectorFromContacts(FloatArray &answer, TimeStep *tStep, CharType type, ValueModeType mode,
                                             const UnknownNumberingScheme &s, Domain *domain, FloatArray *eNorms)
    {
        if( domain->hasContactManager()) {
    ...
    void
    zsEngngModel :: updateComponent(TimeStep *tStep, NumericalCmpn cmpn, Domain *d)
    {
