...
#ifndef ZSIM_ZSMEMORY_H
#define ZSIM_ZSMEMORY_H
...
*/
    ...
    {
#if defined(ZSIM_EXTRA_DEBUG) && ! defined(_MSC_VER)
...
#if defined(ZSIM_WITH_MPQ) || defined(ZSIM_WITH_MPFR)
...
static const zsim::memory::nullptr_t nullptr ={};
#endif

#endif //ZSIM_ZSMEMORY_H
