...
#include "zsContextMode.h"
#include "zsDofIDItem.h"
#include "zsNumericalCmpn.h"
#include "zsValueModeType.h"
#include "zsAssemblerCallback.h"
#include "zsCharType.h"
...
namespace zsim {
    ...
    public:
         ...
         */
        void saveStepContext(zsTimeStep *tStep, zsContextMode mode);
        /**
         ...
         */
        virtual double giveUnknownComponent(zsValueModeType, zsTimeStep *, zsDomain *, zsDof *) { return 0.0; }
         ...
         *
         */
        virtual zsFieldPtr giveField (zsFieldType key, zsTimeStep *) { return zsFieldPtr();}
    ...
    zsProblemCommunicator *giveProblemCommunicator(EngngModelCommType t) {
         ...
         */
        virtual void saveContext(zsDataStream &stream, zsContextMode mode);
        /**
         ...
         */
        virtual void restoreContext(zsDataStream &stream, zsContextMode mode);
        /**
        ...
        zsExportModuleManager *giveExportModuleManager() { return &exportModuleManager; }
        /// Returns reference to receiver timer (EngngModelTimer).
        zsEngngModelTimer *giveTimer() { return & timer; }
         ...
         * @param d zsDomain.
         */
        virtual void updateSolution(zsFloatArray &solutionVector, zsTimeStep *tStep, zsDomain *d);
        /**
         * Updates the solution (guess) according to the new values.
         ...
         */
        virtual void updateInternalRHS(zsFloatArray &answer, zsTimeStep *tStep, zsDomain *d, zsFloatArray *eNorm);
        /**
         * Updates the solution (guess) according to the new values.
         * Callback for nonlinear solvers (e.g. Newton-Raphson).
         ...
         * @param d zsDomain.
         */
        virtual void updateMatrix(zsSparseMtrx &mat, zsTimeStep *tStep, zsDomain *d);
        /**
         ...
         * given zsValueModeType and time step. This function is used by particular dofs
        ...
        virtual void assemble(zsSparseMtrx &answer, zsTimeStep *tStep,
                              const MatrixAssembler &ma, const zsUnknownNumberingScheme &s,  zsDomain *domain);
        /**
         * Assembles characteristic matrix of required type into given sparse matrix.
         * @param answer assembled matrix
         * @param tStep Time step, when answer is assembled.
         ...
         */
        virtual void assemble(zsSparseMtrx &answer, zsTimeStep *tStep,
                              const MatrixAssembler &ma, const zsUnknownNumberingScheme &r_s, const zsUnknownNumberingScheme &c_s,  zsDomain *domain);
        /**
         ...
         */
        void assembleVector(zsFloatArray &answer, zsTimeStep *tStep, const VectorAssembler &va, zsValueModeType mode,
                            const zsUnknownNumberingScheme &s,  zsDomain *domain, zsFloatArray *eNorms = NULL);
        /**
         ...
         */
        void assembleVectorFromDofManagers(zsFloatArray &answer, zsTimeStep *tStep, const VectorAssembler &va, zsValueModeType mode,
                                           const zsUnknownNumberingScheme &s,  zsDomain *domain, zsFloatArray *eNorms = NULL);
        /**
         ...
         * @return Sum of element norm (squared) of assembled vector.
         */
        void assembleVectorFromElements(zsFloatArray &answer, zsTimeStep *tStep, const VectorAssembler &va, zsValueModeType mode,
                                        const zsUnknownNumberingScheme &s,  zsDomain *domain, zsFloatArray *eNorms = NULL);
         ...
         * @param eNorms Norms for each dofid (optional).
         */
        void assembleVectorFromBC(zsFloatArray &answer, zsTimeStep *tStep, const VectorAssembler &va, zsValueModeType mode,
                                  const zsUnknownNumberingScheme &s,  zsDomain *domain, zsFloatArray *eNorms = NULL);
         ...
         * @return Sum of element norm (squared) of assembled vector.
         */
        void assembleExtrapolatedForces(zsFloatArray &answer, zsTimeStep *tStep, zsCharType type, zsDomain *domain);

        void assemblePrescribedExtrapolatedForces(zsFloatArray &answer, zsTimeStep *tStep, zsCharType type, zsDomain *domain);


        void assembleVectorFromContacts(zsFloatArray &answer, zsTimeStep *tStep, zsCharType type, zsValueModeType mode,
                                        const zsUnknownNumberingScheme &s, zsDomain *domain, zsFloatArray *eNorms = NULL);
    ...
    public:
         ...
         */
        virtual zsFMode giveFormulation() { return nonLinFormulation; }
        /*
        ...
        virtual double giveVariableScale(zsVarScaleType varId) { return 1.0; }
