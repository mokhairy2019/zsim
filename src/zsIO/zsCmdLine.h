...
#ifndef ZSIM_ZSCMDLINE_H
#define ZSIM_ZSCMDLINE_H

#include "zsCore/zsForwardDeclarations.h"

namespace zsim{
    class zsCmdLinePrivate;
 ...
 *  {
 *      std::string name("zsim");
 *
 *      zsCmdLine cmd("This is my hello world example."); // Constructor
 *
...
class zsCmdLine
    ...
    zsCmdLine(const std::string& message,
